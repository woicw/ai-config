...
This skill covers Woic's preferred tooling, configurations, and best practices for web development.
...
| Topic | Description | Reference |
|-------|-------------|-----------|
| App Development | Preferences for React/Vite/Next/TailwindCSS web applications | [app-development](references/app-development.md) |
